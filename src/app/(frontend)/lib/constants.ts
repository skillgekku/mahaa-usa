...
export const TANA_PLAYLIST: YouTubeVideo[] = [
  ...
  },
  {
    ...
    description:
      'Business networking and entrepreneurship discussions with Telugu business leaders',
    youtubeId: 'Izd-SLokbPY',
    duration: '2:15:20',
    category: 'Business',
    scheduledTime: '11:00',
...
export const NATS_PLAYLIST: YouTubeVideo[] = [
  {
    ...
    description:
      'North American Telugu Society 8th annual conference highlights and cultural programs',
...
export const CONFERENCES: ChannelConfig[] = [
  {
    ...
    logo: 'https://raw.githubusercontent.com/skillgekku/media-assets/refs/heads/main/TANA.png',
    isYoutube: true,
