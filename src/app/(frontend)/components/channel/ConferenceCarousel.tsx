  ...
  return (
    <div className="w-full max-w-6xl mx-auto mb-12">
      ...
      <div className="flex items-stretch gap-4">
        {/* Left Ad Banner */}
        <div className="hidden lg:flex w-48 bg-gray-800 text-white rounded-2xl shadow-2xl p-4 items-center justify-center text-center">
          {/* Replace with image or any promotional content */}
          <span className="text-sm font-medium">🔥 Early Bird Tickets Available Now!</span>
        </div>
            ...
            {conferences.map((conference) => (
              ...
              >
                <div className="max-w-3xl mx-auto text-center">
                  <h3 className="text-2xl md:text-4xl font-bold mb-4">{conference.name}</h3>
                  <p className="text-base md:text-lg mb-6">{conference.description}</p>

                  <button
                    onClick={() => onConferenceSelect(conference)}
                    className={`bg-gradient-to-r ${conference.bgGradient} hover:opacity-90 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl flex items-center space-x-3 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl min-w-max mx-auto`}
                  >
        ...
        <div className="hidden lg:flex w-48 bg-gray-800 text-white rounded-2xl shadow-2xl p-4 items-center justify-center text-center">
          {/* Replace with image or any promotional content */}
          <span className="text-sm font-medium">📢 Sponsor This Event!</span>
        </div>
      </div>
      ...
      <div className="mt-8">
        <div className="flex items-center justify-between mb-4">
          <h3 className={`text-xl md:text-2xl font-bold ${theme.title}`}>Sponsored Posts</h3>
